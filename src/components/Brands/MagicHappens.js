...
const MagicHappens = () => {
  return (
    <div className="h-fit md:h-[370px] bg-black grid grid-cols-1 md:grid-cols-3  p-2 lg:px-24 mb-20 gap-14 text-white">
      <div className="flex flex-col items-center gap-4 justify-center">
        <img src="/images/carousel/hero.png" alt="" className="h-28 lg:h-36" />
      ...
      <div className="flex gap-4  flex-col items-center justify-center">
        <img src="/images/carousel/dsd.png" alt="" className="h-28 lg:h-36" />
        <h2 className="text-xl lg:text-2xl border border-[#fc0f6663] magic-title text-center bg-black p-3 rounded-xl -mt-[37px]">
          Share UGC
        </h2>
        <p className="text-center ">
      ...
      <div className="flex gap-4 mt-1 lg:mt-4  flex-col items-center justify-center">
        <img src="/images/carousel/FFF.png" alt="" className="h-28 lg:h-36" />
        <h2 className="text-xl lg:text-2xl border border-[#fc0f6663]  magic-title text-center bg-black p-3 rounded-xl -mt-[37px]">
          Earn rewards
        </h2>
        <p className="text-center ">
