          ...
          <div className=" grid grid-cols-1 lg:grid-cols-2 h-full mt-10 lg:-mt-20 gap-5 px-10">
            ...
            <div className=" text-white flex justify-start items-center">
              <div className="ml-0 lg:-ml-32 -mt-12">
                ...
                <p className="font-bold text-center md:text-start text:base lg:text-2xl my-5 text-gray-400">
                  Using your customers and local influencers
                </p>

                <p className="font-thin md:text-start text:base lg:text-xl 2xl:text-xl mb-5 md:mb-0 text-justify">
